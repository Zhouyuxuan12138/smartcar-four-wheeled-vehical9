...
void our_menu_test(menu_list_t *menu)
{
    ...
    MENU_ListInsert(menu, MENU_ItemConstruct(menuType, TestList, "9th_testMenu", 0, 0));
    {
        ...
        MENU_ListInsert(TestList,
                        MENU_ItemConstruct(varfType, &(c_data[0].M_Kp), "M_kp",15, menuItem_data_global));
        MENU_ListInsert(TestList,
                        MENU_ItemConstruct(varfType, &(c_data[0].M_Ki), "M_Ki",16, menuItem_data_global));
        MENU_ListInsert(TestList, MENU_ItemConstruct(nullType, NULL, "servo", 0, 0));
        MENU_ListInsert(TestList,
